...
python3 demo.py  --config config/fashion-256.yaml --driv
ing_video mayun.mp4 --source_image yyy.jpeg --checkpoint checkpoint/fashion.pth.tar --relative --adapt_scale


import ffmpy
ff = ffmpy.FFmpeg(
     inputs={'mayun.mp4': None},
